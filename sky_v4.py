...
with open('js/app/sky.js', 'w', encoding='utf-8') as f:
    f.write(SKY_JS)
print('sky v4.0 written — dots, crosses, stars, streaks, rings, diamonds')
print()
print('git add js/app/sky.js && git commit -m "feat: sky v4 — shaped particles" && git push --force origin main')
