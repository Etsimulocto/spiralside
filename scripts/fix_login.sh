#!/bin/bash
# ============================================================
# SPIRALSIDE — FIX LOGIN ROUTING
# Login succeeds but screen doesn't change — this fixes it
...
echo "✅ auth.js written with login routing fix"
git add js/app/auth.js
git commit -m "fix: route to app on SIGNED_IN event"
git push
