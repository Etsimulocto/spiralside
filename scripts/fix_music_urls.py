#!/usr/bin/env python3
# ============================================================
# SPIRALSIDE — fix_music_urls.py
# Fixes music.js to fetch playlist.json from GitHub (Vercel)
# and resolves HF MP3 URLs correctly
# Run from ~/spiralside: py fix_music_urls.py
# ============================================================
...
print('🔧 Fixing music URLs...')

# ── Write corrected music.js ──────────────────────────────────
# playlist.json lives in GitHub repo (served by Vercel at /utilities/music/playlist.json)
# MP3s live on HuggingFace space, resolved via /resolve/main/
music_js = '''// ============================================================
...
# ── Verify playlist.json exists and is correct ────────────────
playlist_path = os.path.join(BASE, 'utilities', 'music', 'playlist.json')
if os.path.exists(playlist_path):
    print('  ✓ utilities/music/playlist.json exists')
    with open(playlist_path, 'r') as f:
        print('  content:', f.read()[:200])
else:
    # Write it
    write('utilities/music/playlist.json', '''{
  "tracks": [
    { "id": "spiralside",  "title": "SPIRALSIDE",  "file": "utilities/music/SPIRALSIDE.mp3"       },
    { "id": "centerspark", "title": "Centerspark",  "file": "utilities/music/Centerspark (1).mp3"  },
    { "id": "mirrorblade", "title": "Mirrorblade",  "file": "utilities/music/Mirrorblade.mp3"      }
...
print('   cd ~/spiralside')
print('   git add .')
print('   git commit -m "feat: music player with HF streaming"')
print('   git push')
print()
print('📍 How it works:')
print('   playlist.json  → served from Vercel (your GitHub repo)')
print('   MP3 files      → streamed from HuggingFace resolve URL')
print('   No HF upload needed for playlist — it lives in GitHub!')
