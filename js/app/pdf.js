  ...
  try {
    ...
    if (isIOS || isSafari) {
      ...
      overlay.innerHTML = '<div style="width:100%;max-width:480px;display:flex;align-items:center;justify-content:space-between;padding:12px 16px;background:#111118;border-bottom:1px solid #1e1e2e;">'
        ...
        + '<div style="color:#e8e8f0;font-family:monospace;font-size:0.7rem;line-height:2;">Tap <strong style="color:#00F6D6;">Print</strong> in the Safari share sheet &rarr; pinch open the preview &rarr; tap share &#8679; again &rarr; <strong style="color:#00F6D6;">Save to Files</strong></div>'
        + '</div></div>'
