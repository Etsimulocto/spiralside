...
export function injectImagineStyles() {
  ...
  s.textContent = `
    ...
    .imagine-header { font-size:var(--subtext-size); letter-spacing:0.14em; text-transform:uppercase; color:var(--teal); font-family:var(--font-ui); font-weight:600; padding-top:4px; }
    ...
    .imagine-label { font-size:var(--subtext-size); letter-spacing:0.12em; text-transform:uppercase; color:var(--subtext); font-family:var(--font-ui); }
    .imagine-sublabel { color:var(--teal); font-size:var(--subtext-size); margin-left:6px; letter-spacing:0.06em; }
    ...
    .size-sub { font-size:var(--subtext-size); color:var(--teal); display:block; opacity:0.8; }
    ...
    .imagine-error { font-size:var(--subtext-size); color:var(--pink); min-height:16px; text-align:center; font-family:var(--font-ui); }
    ...
    .imagine-tier { font-size:var(--subtext-size); letter-spacing:0.1em; color:var(--subtext); text-align:center; text-transform:uppercase; margin-bottom:6px; font-family:var(--font-ui); }
