...
function cutIDB(store, mode) {
  return new Promise((res, rej) => {
    const req = indexedDB.open('spiralside');  // no version — use existing
    req.onsuccess = e => {
...
window._cutGenImage = function() {
  ...
  if (sourcePrint) {
    ...
    ctx = {
      ...
      visualDesc: sourceScene.visual_desc || sourceScene.caption || '',
    ...
    ctx = {
      ...
      visualDesc: sourceWorld.visual_desc             || sourceWorld.lore?.slice(0, 200) || '',
