...
const MODELS = [
  ...
  { id:'kolors', label:'kolors',               sub:'anime · vibrant · Kwai-Kolors',             cost:1500, color:'var(--pink)',   icon:'🌸' },
  { id:'sd35',   label:'stable diffusion 3.5', sub:'photorealistic · versatile · Stability AI', cost:2000, color:'#FFD93D',       icon:'🔥' },
