...
const MODELS = [
  ...
  { id:'kolors', label:'animagine xl', sub:'anime specialist · HuggingFace',             cost:1500, color:'var(--pink)',   icon:'🌸' },
  { id:'sd35', label:'dreamshaper xl', sub:'creative · versatile · HuggingFace', cost:2000, color:'#FFD93D',       icon:'🔥' },
